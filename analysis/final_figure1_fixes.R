# Final Figure 1 with Panel C axis labels closer and Panel D properly ordered
library(dplyr)
library(ggplot2)
library(gridExtra)
library(grid)

cat("Creating final Figure 1 with Panel C and D fixes...\n")
...
# PANEL C: Individual Choice Patterns - FIXED axis label positioning
...
# Create Panel C with CLOSER axis labels
panel_1c_titled <- arrangeGrob(
  ...
  heights = c(0.08, 0.08, 0.37, 0.37, 0.08),
...
# PANEL D: Individual Exploration Rates by Sex - FIXED colors and ordering
...
ggsave("results/figures/Figure1_FINAL_FIXED.png", figure_1_final, 
       width = 500, height = 380, units = "mm", dpi = 300)

ggsave("results/figures/Figure1_FINAL_FIXED.tiff", figure_1_final, 
       width = 500, height = 380, units = "mm", dpi = 300, compression = "lzw")

cat("\n=============================================================================\n")
cat("FINAL FIGURE 1 WITH FIXES COMPLETE!\n") 
cat("=============================================================================\n")
cat("✓ Panel C: Axis labels moved closer to the graphs\n")
cat("✓ Panel D: Different colors (Orange for Males, Purple for Females)\n")
cat("✓ Panel D: Proper ordering - F D E (Males) | C I A (Females)\n")
cat("✓ Panel D: Visual separator between male and female groups\n")
cat("✓ Panel D: Group labels added for clarity\n")
cat("✓ All panels maintain uniform professional formatting\n")
