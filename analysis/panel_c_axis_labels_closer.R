# Fix Panel C axis labels to be much closer to the graphs
library(dplyr)
library(ggplot2)
library(gridExtra)
library(grid)

cat("Moving Panel C axis labels much closer to graphs...\n")
...
# PANEL C: Individual Choice Patterns - MUCH CLOSER axis labels
...
# Create Panel C with MUCH CLOSER axis labels
panel_1c_titled <- arrangeGrob(
  ...
  # Y-axis label - MOVED MUCH CLOSER to graphs
  textGrob("Proportion of Choices", gp = gpar(fontsize = 9, fontface = "bold"), 
           x = 0.08, y = 0.45, hjust = 0.5, vjust = 0.5, rot = 90),
  # Main plots
  panel_1c_plots,
  # X-axis label - MOVED MUCH CLOSER to graphs
  ...
  widths = c(0.12, 0.20, 0.20, 0.20, 0.20, 0.08)
)
...
ggsave("results/figures/Figure1_PANEL_C_CLOSER_LABELS.png", figure_1_final, 
       width = 500, height = 380, units = "mm", dpi = 300)

ggsave("results/figures/Figure1_PANEL_C_CLOSER_LABELS.tiff", figure_1_final, 
       width = 500, height = 380, units = "mm", dpi = 300, compression = "lzw")

cat("\n=============================================================================\n")
cat("PANEL C AXIS LABELS MOVED MUCH CLOSER!\n") 
cat("=============================================================================\n")
cat("✓ Y-axis label moved from x=0.04 to x=0.08 (much closer to graphs)\n")
cat("✓ X-axis label moved from y=0.05 to y=0.12 (much closer to graphs)\n")
cat("✓ Adjusted layout matrix widths and heights for better spacing\n")
cat("✓ Maintained all other formatting and colors\n")
cat("✓ Panel D remains unchanged with proper ordering and colors\n")
