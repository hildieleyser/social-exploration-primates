# Move Male and Female labels closer to the right-hand side of Panel C
library(dplyr)
library(ggplot2)
library(gridExtra)
library(grid)

cat("Moving Male/Female labels closer to right side of Panel C...\n")
...
# PANEL C: Individual Choice Patterns - Male/Female labels CLOSER to right side
...
# Create Panel C with Male/Female labels MUCH CLOSER to right side
panel_1c_titled <- arrangeGrob(
  ...
  # Sex labels - MUCH CLOSER to right edge (x=0.98 instead of 0.97)
  textGrob("Male", gp = gpar(fontsize = 9, fontface = "bold"), 
           x = 0.98, y = 0.72, hjust = 0.5, vjust = 0.5, rot = 270),
  textGrob("Female", gp = gpar(fontsize = 9, fontface = "bold"), 
           x = 0.98, y = 0.28, hjust = 0.5, vjust = 0.5, rot = 270),
  ...
  widths = c(0.05, 0.22, 0.22, 0.22, 0.22, 0.05)
)
...
ggsave("results/figures/Figure1_SEX_LABELS_CLOSER.png", figure_1_final, 
       width = 500, height = 380, units = "mm", dpi = 300)

ggsave("results/figures/Figure1_SEX_LABELS_CLOSER.tiff", figure_1_final, 
       width = 500, height = 380, units = "mm", dpi = 300, compression = "lzw")

cat("\n=============================================================================\n")
cat("MALE/FEMALE LABELS MOVED CLOSER TO RIGHT SIDE!\n") 
cat("=============================================================================\n")
cat("✓ Male/Female labels moved from x=0.97 to x=0.98 (closer to right edge)\n")
cat("✓ Reduced right margin (width from 0.07 to 0.05) for tighter spacing\n")
cat("✓ Y-axis and X-axis labels remain close to graphs\n")
cat("✓ All other formatting maintained\n")
cat("✓ Now much tighter spacing on the right side\n")
