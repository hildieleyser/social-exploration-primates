...
# =============================================================================
# Simplified version without arrows and text annotations
# =============================================================================
...
# Create P1: Additive Social Heat-Map (simplified)
...
# Save combined plot
ggsave("G6_final_panels_simple.pdf", combined_plot, width = 16, height = 8, dpi = 300)
ggsave("G6_final_panels_simple.png", combined_plot, width = 16, height = 8, dpi = 300)

# Save individual panels
ggsave("G6_P1_heatmap_simple.pdf", p1_heatmap, width = 10, height = 8, dpi = 300)
ggsave("G6_P1_heatmap_simple.png", p1_heatmap, width = 10, height = 8, dpi = 300)

ggsave("G6_P2_alluvial_simple.pdf", p2_alluvial, width = 10, height = 8, dpi = 300)
ggsave("G6_P2_alluvial_simple.png", p2_alluvial, width = 10, height = 8, dpi = 300)
...
cat("Files created:\n")
cat("- G6_final_panels_simple.pdf (combined panels)\n")
cat("- G6_final_panels_simple.png (combined panels)\n")
cat("- G6_P1_heatmap_simple.pdf/png (additive social heat-map)\n")
cat("- G6_P2_alluvial_simple.pdf/png (decision-flow alluvial)\n")
cat("\nNarrative flow:\n")
