...
ggsave("G1_exploration_vs_uncertainty_FIXED.png", p_G1, width = 10, height = 8, dpi = 300)
ggsave("G1_exploration_vs_uncertainty_FIXED.pdf", p_G1, width = 10, height = 8)
...
ggsave("G2_context_ribbon_FIXED.png", p_G2, width = 10, height = 8, dpi = 300)
ggsave("G2_context_ribbon_FIXED.pdf", p_G2, width = 10, height = 8)
...
ggsave("G3_rank_comparison_FIXED.png", p_G3, width = 10, height = 8, dpi = 300)
ggsave("G3_rank_comparison_FIXED.pdf", p_G3, width = 10, height = 8)
...
ggsave("G4_heatmap_all_FIXED.png", p_G4, width = 10, height = 8, dpi = 300)
ggsave("G4_heatmap_all_FIXED.pdf", p_G4, width = 10, height = 8)
...
ggsave("G4_heatmap_males_FIXED.png", p_G4_male, width = 10, height = 8, dpi = 300)
ggsave("G4_heatmap_males_FIXED.pdf", p_G4_male, width = 10, height = 8)
...
ggsave("G4_heatmap_females_FIXED.png", p_G4_female, width = 10, height = 8, dpi = 300)
ggsave("G4_heatmap_females_FIXED.pdf", p_G4_female, width = 10, height = 8)
...
ggsave("G5_caterpillar_FIXED.png", p_G5, width = 10, height = 8, dpi = 300)
ggsave("G5_caterpillar_FIXED.pdf", p_G5, width = 10, height = 8)

# ============================================================================
# G6: Calibration Curve (Identity & Prediction) - FIXED with explanation
# ============================================================================
...
ggsave("G6_calibration_FIXED.png", p_G6, width = 10, height = 8, dpi = 300)
ggsave("G6_calibration_FIXED.pdf", p_G6, width = 10, height = 8)
...
ggsave("G7_accuracy_ladder_FIXED.png", p_G7, width = 10, height = 8, dpi = 300)
ggsave("G7_accuracy_ladder_FIXED.pdf", p_G7, width = 10, height = 8)
...
cat("Files saved as PNG and PDF formats with '_FIXED' suffix.\n") 