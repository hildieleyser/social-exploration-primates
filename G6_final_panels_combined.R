# =============================================================================
# G6 - FINAL PANELS: P1 & P2 COMBINED
# =============================================================================
# Combines the working individual panels
# =============================================================================
...
# Save combined plot
ggsave("G6_final_panels_combined.pdf", combined_plot, width = 16, height = 8, dpi = 300)
ggsave("G6_final_panels_combined.png", combined_plot, width = 16, height = 8, dpi = 300)
...
cat("\nKey insights:\n")
cat("- Model captures 86% of decisions correctly\n")
...
cat("Files created:\n")
cat("- G6_final_panels_combined.pdf (combined panels)\n")
cat("- G6_final_panels_combined.png (combined panels)\n")
