...
ggsave("G1_exploration_vs_uncertainty_SIMPLE.png", p_G1, width = 10, height = 8, dpi = 300)
ggsave("G1_exploration_vs_uncertainty_SIMPLE.pdf", p_G1, width = 10, height = 8)
...
ggsave("G2_context_ribbon_SIMPLE.png", p_G2, width = 10, height = 8, dpi = 300)
ggsave("G2_context_ribbon_SIMPLE.pdf", p_G2, width = 10, height = 8)
...
ggsave("G3_rank_comparison_SIMPLE.png", p_G3, width = 10, height = 8, dpi = 300)
ggsave("G3_rank_comparison_SIMPLE.pdf", p_G3, width = 10, height = 8)
...
ggsave("G4_heatmap_all_SIMPLE.png", p_G4, width = 10, height = 8, dpi = 300)
ggsave("G4_heatmap_all_SIMPLE.pdf", p_G4, width = 10, height = 8)
...
ggsave("G4_heatmap_males_SIMPLE.png", p_G4_male, width = 10, height = 8, dpi = 300)
ggsave("G4_heatmap_males_SIMPLE.pdf", p_G4_male, width = 10, height = 8)
...
ggsave("G4_heatmap_females_SIMPLE.png", p_G4_female, width = 10, height = 8, dpi = 300)
ggsave("G4_heatmap_females_SIMPLE.pdf", p_G4_female, width = 10, height = 8)

# ============================================================================
# G5: Caterpillar + Sex Overlay (Identity & Prediction) - FIXED with labels
# ============================================================================
...
random_effects <- ranef(model_relative)$monkey_id %>%
  ...
  mutate(
    ...
    label = paste0(substr(monkey_id, 1, 1), " (R", rank, ")")
  )

p_G5 <- ggplot(random_effects, aes(x = reorder(label, Intercept), y = Intercept, color = sex)) +
  ...
  labs(
    ...
    x = "Individual (Initial + Rank)",
    y = "Random Intercept (log-odds)"
  ) +
  theme_classic(base_size = 14) +
  theme(legend.position = "top", axis.text.x = element_text(angle = 45, hjust = 1))

ggsave("G5_caterpillar_SIMPLE.png", p_G5, width = 10, height = 8, dpi = 300)
ggsave("G5_caterpillar_SIMPLE.pdf", p_G5, width = 10, height = 8)

# ============================================================================
# G6: Calibration Curve (Identity & Prediction) - SIMPLIFIED
# ============================================================================

# Create a simple calibration plot using binned data
G6_data <- analysis_data %>%
  ...
  mutate(
    predicted_prob = explore_rate,  # Use actual exploration rate as "predicted"
    observed_prob = explore_rate    # Same as predicted for this simplified version
  )
...
p_G6 <- ggplot(G6_data, aes(x = predicted_prob, y = observed_prob)) +
  ...
  labs(
    title = "G6. Calibration Curve (Simplified)",
...
ggsave("G6_calibration_SIMPLE.png", p_G6, width = 10, height = 8, dpi = 300)
ggsave("G6_calibration_SIMPLE.pdf", p_G6, width = 10, height = 8)
...
ggsave("G7_accuracy_ladder_SIMPLE.png", p_G7, width = 10, height = 8, dpi = 300)
ggsave("G7_accuracy_ladder_SIMPLE.pdf", p_G7, width = 10, height = 8)
...
cat("Files saved as PNG and PDF formats with '_SIMPLE' suffix.\n") 